...
const FAKE_ADMIN = {
  status: "success",
  token:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2MzlmZmYwNGVjMTRjNWY0MDFhZTQxNyIsImN1cnJlbnRSb2xlIjoiQWRtaW4iLCJpYXQiOjE3MTUxODk4ODgsImV4cCI6MTcyMjk2NTg4OH0.bHNztrNJluKismes9-dEo63839SMoBvP3adiSo0mfqU",
  user: {
    authentication: {
      isVerified: true,
    },
...
const FAKE_USER = {
  status: "success",
  token:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY2MzlmZokwNGVjMTRjNWY0MDFhZTQxNyIsImN1cnJlbnRSb2xlIjoiQWRtaW4iLCJpYXQiOjE3MTUxODk4ODgsImV4cCI6MTcyMjk2NTg4OH0.bHNztrNJluKismes9-dEo63839SMoBvP3adiSo0mfqU",
  user: {
    authentication: {
      isVerified: true,
    },
    name: "user",
    email: "mehdioo@gmail.com",
    password: "4321",
    role: "User",
  },
};
